...
const CommentsComponent = () => {
  ...
  const getAllScoutComments = async () => {
    ...
    try {
      let response = await fetch(
        `${process.env.NEXT_PUBLIC_API_URL}/scouts/${router.query.scout_id}/comments/all`,
        options
      );
  ...
  const deleteComment = async (commnet_id: any) => {
    ...
    try {
      let response = await fetch(
        `${process.env.NEXT_PUBLIC_API_URL}/scouts/${router.query.scout_id}/comments/${commnet_id}`,
        options
      );
      let responseData = await response.json();
      if (responseData.success == true) {
  ...
  const afterDeleteAttachements = async (attachmentID: any, commentId: any) => {
    ...
    try {
      let response = await fetch(
        `${process.env.NEXT_PUBLIC_API_URL}/scouts/${router.query.scout_id}/${commentId}/attachments`,
        options
      );
      let responseData = await response.json();
      if (responseData.success == true) {
