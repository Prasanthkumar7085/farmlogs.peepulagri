...
import GoogleMapViewComponent from "@/components/Scouting/Forms/GoogleMapsPolygon/GooglePolygonView";
          ...
          <div className={styles.viewFarmDetailsCard}>
            ...
            <div style={{ display: "flex", flexDirection: "column", width: data?.geometry?.coordinates?.length ? "50%" : "100%" }}>
              ...
              <div style={{
                ...
                alignItems: "center",
                alignSelf: "stretch",
                justifyContent: data?.geometry?.coordinates?.length ? "flex-start" : "flex-end",
                gap: "0.2rem",
                marginTop: "10px",
                cursor: "pointer"
              }}
