  ...
  return (
    <div>
      ...
      <div
        ...
        style={{
          display: "grid",
          gridTemplateColumns: farmId ? "1fr 1fr" : "1fr",
          gridGap: "1rem",
        }}
      >
        <Box
        ...
        {data?.length ? (
            ...
            if (data.length === index + 1 && hasMore == true) {
              return (
                ...
                >
                  <div className={styles.header}>
                    <div className={styles.summaryHeading}>
                      <h4 className={styles.date}>
                        {timePipe(item.date, "ddd DD-MMM-YYYY")}
                      </h4>
                  ...
                  <p className={styles.chilliBeingA}>{item.content}</p>
                </div>
              );
            } else {
              return (
                ...
                >
                  <div className={styles.header}>
                    <div className={styles.summaryHeading}>
                      <h4 className={styles.date}>
                        {timePipe(item.date?.slice(0, 10), "DD MMM, YYYY")}
                      </h4>
          ...
          >
            <NoDataMobileComponent
              ...
              noDataImg={"/NoDataImages/No_summary.svg"}
            />
      ...
      <div className="addFormPositionIcon">
        <IconButton
          ...
          onClick={() => {
            router.push(`/summary/add`);
          }}
        >
          <img
            src="/mobileIcons/summary/add-summary-icon.svg"
            alt=""
            width={"24px"}
          />
