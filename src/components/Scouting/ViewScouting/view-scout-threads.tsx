    ...
    <div className={styles.viewscoutthreads} id="view-scout-threads">
      {cameraOpen == false ? (
        <div className={styles.headerandattachments}>
          <div className={styles.headertextwrapper}>
            <h2 className={styles.farmTitle}>
              {data?.farm_id?.title ? data?.farm_id?.title : "Farm1"}
            </h2>
          ...
          <div className={styles.attachmentscontainer}>
            ...
            >
              <div
                style={{
                  display: "grid",
                  gridTemplateColumns:
                    "repeat(3, 1fr)" /* Four columns with a width of 60px each */,
                  gridGap: "0.5rem",
                  margin: "0.5rem",
                }}
              >
                    ...
                    >
                      ...
                      >
                        <Checkbox
                          ...
                          size="small"
                          checked={
                            tempImages.find((ite: any) => ite == image.id)
                              ? true
                              : false
                          }
            ...
            {fileUploadOpen == false ? <CommentsComponent /> : ""}
          </div>
        </div>
      ) : (
        ""
      ...
      {fileUploadOpen == true && (
        <FileUploadEditComponent
          captureFileUploadOptions={captureFileUploadOptions}
        />
      )}
      ...
      <VideoDialogForScout
        ...
        mediaArray={selectedFile}
        captureSlideImagesIndex={(index: number) => setIndexOfseletedOne(index)}
        index={indexOfSeletedOne}
        data={data}
      />
      {tempImages?.length !== 0 ? (
        <div
        ...
        >
          ...
          >
            ...
            <p style={{ margin: "0 ", fontWeight: "500" }}>Delete</p>
          </div>
        </div>
      ) : (
        ""
