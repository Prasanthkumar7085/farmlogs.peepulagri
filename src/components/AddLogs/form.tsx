...
const Form = ({ loadAttachments, deleteSelectedFile, setResources, setAdditionalResources, captureDates, setWorkType, setCategoryList, singleLogDetails, setActiveStepBasedOnData, onChangeFile, uploadFiles, files, uploadButtonLoading, uploadFailed, errorMessages, captureCategoriesArray }: any) => {
  ...
  return (
    <section className={styles.form}>
      ...
      <LogAttachments loadAttachments={loadAttachments} deleteSelectedFile={deleteSelectedFile} onChangeFile={onChangeFile} uploadFiles={uploadFiles} files={files} uploadButtonLoading={uploadButtonLoading} uploadFailed={uploadFailed} />
    </section>
  );
};
