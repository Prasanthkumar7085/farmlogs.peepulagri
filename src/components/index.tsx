    ...
    <main className={styles.dashboard}>
      <section className={styles.dashboard1}>
        <div className={styles.farmcardlists}>
          <a className={styles.farmcard}>
            <div className={styles.farmcarddetails}>
              ...
              <div className={styles.title}>
                <h4 className={styles.farmname}>Farm-1</h4>
                <p className={styles.acrescount}>60 Acres</p>
              </div>
            </div>
            <div className={styles.duration}>
              ...
              />
              <div className={styles.para}>09, Jun 2023 - Current</div>
            </div>
          ...
          <a className={styles.farmcard1}>
            <div className={styles.farmcarddetails}>
              <img
                ...
                src="/farmshape1.svg"
              />
              <div className={styles.farm4Parent}>
                <div className={styles.para}>Farm-2</div>
            ...
            <div className={styles.duration}>
              ...
              />
              <div className={styles.para}>08, Apr 2023 - Current</div>
            </div>
            <div className={styles.statsprogress}>
              <div className={styles.logscount}>
                <div className={styles.para}>Total Logs</div>
                <div className={styles.div}>80</div>
              </div>
              <div className={styles.progressbar1}>
                <div className={styles.para}>Progress</div>
          ...
          <a className={styles.farmcard2}>
            <div className={styles.farmcarddetails2}>
              <img
                className={styles.farmshapeIcon2}
                alt=""
                src="/farmshape2.svg"
              />
              <div className={styles.farm4Parent}>
                <div className={styles.para}>Farm-3</div>
                <div className={styles.acres}>60 Acres</div>
              </div>
            </div>
            <div className={styles.duration2}>
              <img
                ...
                src="/calendaricon1.svg"
              />
              <div className={styles.para}>05, Mar 2023 - 09, Aug 2023</div>
            </div>
            <div className={styles.statsprogress2}>
              <div className={styles.logscount}>
                <div className={styles.para}>Total Logs</div>
          ...
          <a className={styles.farmcard2}>
            <div className={styles.farmcarddetails2}>
              ...
              />
              <div className={styles.farm4Parent}>
                <div className={styles.para}>Farm-4</div>
                <div className={styles.acres}>60 Acres</div>
              </div>
            </div>
            <div className={styles.duration2}>
              <img
                ...
                src="/calendaricon1.svg"
              />
              <div className={styles.para}>01, Mar 2023 - Current</div>
            </div>
            <div className={styles.statsprogress2}>
              <div className={styles.logscount}>
        ...
        <div className={styles.farmdashboarddetails}>
          ...
          <div className={styles.header}>
            <h3 className={styles.title3}>Farms Dashboard</h3>
